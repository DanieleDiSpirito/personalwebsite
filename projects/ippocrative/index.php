...
<body>
    <form method="POST" action="index.php">
        <div class="svgContainer">
            <div>
                <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                    ...
                    <circle cx="100" cy="100" r="100" fill="#344060" />
                    <g class="body">
        ...
        <div class="inputGroup inputGroup1">
            ...
            <input type="text" name="email" id="email" class="email" maxlength="256" placeholder="your@email.com"/>
            <span class="indicator"></span>
        </div>
        <div class="inputGroup inputGroup2">
            <label for="password">Password</label>
            <input type="password" name="password" id="password" class="password" />
            <button type="button" class="eye" onclick="togglePassword()"><i class="bi bi-eye"></i></button>
        </div>
        ...
        <div style="display: flex; justify-content: space-between">
            <a href="quiz.php" style="text-decoration: none;">Gioca senza registrarti</a>
            <a href="" style="text-decoration: none;">Registrati</a>
        </div>
    </form>

...
<body>
            ...
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" name="form" method="POST" action="">
                    ...
                    <div class="wrap-input100 validate-input">
                        ...
                        <span class="focus-input100" data-placeholder="&#xe80f;"></span>
                        <button type="button" style="position: absolute; right: 5%; top: 3rem;" onclick="toggleConfermaPassword()"><i class="bi bi-eye" style="font-size: 20px"></i></button>
                    </div>
    ...
    <script>
        ...
        const toggleConfermaPassword = () => {
            eyeIcon = document.getElementsByTagName('i')[2]
            if (eyeIcon.classList.contains('bi-eye')) {
                eyeIcon.classList.add('bi-eye-slash')
                eyeIcon.classList.remove('bi-eye')
                document.querySelector('input[name=passwordConferma]').type = 'text'
            } else {
                eyeIcon.classList.add('bi-eye')
                eyeIcon.classList.remove('bi-eye-slash')
                document.querySelector('input[name=passwordConferma]').type = 'password'
            }
        }
    </script>
